...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'zomorod_2a2adff02513ef9e8507_20220709094517_archive.zip';
	const ARCHIVE_SIZE		 = '113147873';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2a2adff-09094517';
    const SECONDARY_PACKAGE_HASH = '3d96e53-09094517';
	const VERSION			 = '1.4.7';
