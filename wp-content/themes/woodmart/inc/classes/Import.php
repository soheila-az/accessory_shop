					...
					<?php if ( $type == 'base' ): ?>
						...
						<?php if( ! $this->is_version_imported('base') ): ?>
							...
							<div class="full-import-box">
								...
								<fieldset>
									<legend>پیشنهاد نمی شود</legend>
									<label for="full_import">
										<input type="checkbox" id="full_import" name="full_import" value="yes">
										شامل همه دموها
									</label>
									<br>
									<small>
										با فعال کردن این گزینه <strong>همه ورژن های دمو</strong>
										با هم درون ریزی خواهد شد.
									</small>
								</fieldset>
